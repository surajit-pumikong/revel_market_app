        ...
        return (
            <View style={{ height: '100%', }}>
                ...
                <Footer>
                    ...
                    <FooterTab style={{ backgroundColor: '#ff0000', justifyContent: "center" }}>
                        <TouchableOpacity style={{ alignItems: "center", justifyContent: "center", }}
                            onPress={() => { this.setState({ page: 'News' }) }}
                        >
                            <Icon name="bookmark-multiple" size={24} style={{ color: this.state.page == 'News' ? '#ffffff' : '#797e86', }}/>
                            <Text style={[ styles.text_font, { color: this.state.page == 'News' ? '#ffffff' : '#797e86', } ]}>News</Text>
                        </TouchableOpacity>
                    </FooterTab>
                    <FooterTab style={{ backgroundColor: '#ff9901', justifyContent: "center" }}>
                        <TouchableOpacity style={{ alignItems: "center", justifyContent: "center", }}
                    ...
                    <FooterTab style={{ backgroundColor: '#01ffff', justifyContent: "center" }}>
                        <TouchableOpacity style={{ alignItems: "center", justifyContent: "center", }}
                            onPress={() => { this.setState({ page: 'Profile' }) }}
                        >
                            <Icon name="contacts" size={24} style={{ color: this.state.page == 'Profile' ? '#ffffff' : '#797e86', }}/>
